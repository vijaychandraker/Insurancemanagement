...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Company">
            ...
            <EditItemTemplate>
                <asp:TextBox ID="txtCompanyID" runat="server" Text='<%# Bind("CompanyID") %>' CssClass="form-control"></asp:TextBox>
            </EditItemTemplate>
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="Category">
            ...
            <EditItemTemplate>
                <asp:TextBox ID="txtCategoryID" runat="server" Text='<%# Bind("CategoryID") %>' CssClass="form-control"></asp:TextBox>
            </EditItemTemplate>
        </asp:TemplateField>
